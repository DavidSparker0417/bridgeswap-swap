    ...
    <InputPanel id={id}>
      <Container hideInput={hideInput}>
        {!hideInput && (
          <LabelRow>
            <RowBetween>
              <Text color="#4C4C4C" fontSize="14px">{translatedLabel}</Text>
              {account && (
                <Text onClick={onMax} color="#4C4C4C" fontSize="14px" style={{ display: 'inline', cursor: 'pointer' }}>
